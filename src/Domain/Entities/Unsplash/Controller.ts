...
export default class Controller implements Serviceable {
	...
	@inject(TYPES.GeteableAll) @named(TYPES.UNSPLASH_PROVIDER) private geteableAllService: GeteableAll
	...
	public async update(id: string, data: {}, model: Model<Document, {}>, idUser: string): Promise<Responseable> {
